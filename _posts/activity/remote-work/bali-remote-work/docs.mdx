...
{(globalThis.slug = 'bali-remote-work') && ''}
...
<ImageHorizonWrap slug={slug} list={['surf-interior','delivery-food', 'bicycle']} />
...
<ImageHorizonWrap slug={slug} list={['bird', 'lizard', 'monkey', 'kecak-fire-dance', 'surf', 'walk', 'turtle', 'medicine', 'climbing']} />
...
<ImageHorizonWrap slug={slug} list={['canang-sari', 'la-brisa', 'la-brisa-pad', 'motocycle', 'jungle-water', 'scuba-diving', 'merry-go-round', 'cliff', 'duck', 'shop']} />
...
<ImageHorizonWrap slug={slug} list={['stake', 'banana-soup', 'russian', 'fan-cake', 'fish', 'scrumble', 'duck']} />

음식 이야기가 없으면 안된다고해서;; 음식 사진을 끝으로 마무리 하겠다.

## 마무리

![good-bye-airport](good-bye-airport.webp 'l')
