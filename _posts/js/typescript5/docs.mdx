...
tags: ['typescript', 'frontend', 'javascript', 'devtools']
...
![compare v5 to v4.9](compare-v5-to-v4.webp)

![typescript npm package size](typescript-npm-package-size.webp)
...
- [https://ko.javascript.info/call-apply-decorators#ref-634](https://ko.javascript.info/call-apply-decorators#ref-634)
