...
{(globalThis.slug = 'google-adsense') && ''}
...
<ImageHorizonWrap slug={slug} list={['ad-bottom-mobile','ad-left-rail-desktop']} />
...
![site register](site-register.webp 'l')
...
![ad script register](ad-script-register.webp)
...
<ImageHorizonWrap slug={slug} list={['ad-example','direct-ad']} />
...
![ad-exclusive-area](ad-exclusive-area.webp)
...
![profit structure](profit-structure.webp 'l')
