...
tags: ['vite', 'devtools', 'frontend', 'javascript']
...
![dev-server-logic-summary](dev-server-logic-summary.webp 'l')
...
![init-server-phase](init-server-phase.webp)
...
![index.html-request-phase](html-request-phase.webp 'l')
...
![transpile-ts-to-js](transpile-ts-to-js.webp 'l')
...
![index.html-rendering-phase](html-rendering-phase.webp 'l')

> 3 ~ 4. 브라우저 렌더링 및 정적 자원 요청 상황.

![init-html](init-html.webp)

![browser-initiator](browser-initiator.webp 'l')
...
![inject-import-meta-hot](inject-import-meta-hot.webp 'l')
...
![file-change-phase](file-change-phase.webp 'l')
...
![socket-update-event](socket-update-event.webp 'l')
...
![import response](import-response.webp 'l')
...
5. prefresh에서 심어둔 `flushUpdates` 함수가 [HMR을 수행](https://github.com/preactjs/prefresh/blob/018f5cc907629b82ffb201c32e948efe4b40098a/packages/utils/src/index.js#L11)(컴포넌트 변경)된다.
