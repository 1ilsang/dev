...
tags: ['testing', 'playwright', 'frontend', 'devtools']
...
![test pyramid](test-pyramid.webp)
...
![failed visual regression test](failed-visual-regression-test.webp 'l')
...
![playwright flow](playwright-flow.webp)
...
![github actions](github-actions.webp 'l')
...
![Actions result](actions-result.webp 'l')
...
![workflow job](workflow-job.webp)
...
![failed flow](failed-flow.webp 'l')
...
![compare time](compare-time.webp 's')
...
![Macos runner version](macos-runner-version.webp 'l')
